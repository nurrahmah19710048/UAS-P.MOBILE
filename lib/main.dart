    ...
    backgroundColor: Colors.amberAccent.shade100,
        ...
        body: SafeArea(child: Column(
          ...
          children: [
            ...
            Text('Nama  : Nur Rahmah', style: TextStyle(
              fontSize: 30.0,
              color: Colors.lightGreenAccent.shade50,
              fontWeight: FontWeight.bold,
            ),),

            Text('NPM   : 19710048', style: TextStyle(
              fontSize: 30.0,
              color: Colors.lightGreenAccent.shade50,
              fontWeight: FontWeight.bold,
            ),),
            ...
            Text('Alamat: jl.Keraton no. 7A', style: TextStyle(
              fontSize: 30.0,
              color: Colors.lightGreenAccent.shade50,
              fontWeight: FontWeight.bold,
            ),),

            Text('No hp : 0895605326351', style: TextStyle(
              fontSize: 30.0,
              color: Colors.lightGreenAccent.shade50,
              fontWeight: FontWeight.bold,
            ),),
